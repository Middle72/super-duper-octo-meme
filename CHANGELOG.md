...
### Published the pending theme — everything above is now live
- **What:** User published the duplicate theme (previously "Lucky Penny Pink Redo - Contact Us page") and renamed it **"Lucky Penny Pink 26-08-24"**, now the live/MAIN theme.
- **Now live on the real site:** the Contact Us page (intro, Adopt/Foster/Volunteer/Surrender quick-apply buttons, general message form with phone field removed), the adoptable-cat age display fix (years shown with one decimal), and the phone-field removal from the shared contact-form section.
- **Cleanup opportunity:** two themes are now fully superseded and unpublished — **"Lucky Penny Pink 26-08-01"** (the previous live theme) and **"Lucky Penny Pink 26-07-31"** (superseded before that). Same as past cleanups, I can't delete themes myself (blocked as a safety measure) — user can remove them via Admin → Online Store → Themes → Actions → Delete whenever convenient.
